...
export default function EventCard({ event, onLearnMore, onDelete, isAdmin }) {
  const {
  ...
  return (
    <article className="bg-white rounded-2xl overflow-hidden shadow-md border border-slate-200 relative">
      {/* Image + top-right admin controls */}
      ...
      <div className="p-5">
        ...
        {/* description */}
        <p className="mt-4 text-slate-700 text-sm max-h-20 overflow-hidden">
          {description}
        </p>
